...
app.layout = html.Div([
    # TASK 2.1 Add title to the dashboard
        html.H1("Automobile Sales Statistics Dashboard",
                style={'textAlign': 'center', 'color': '#503D36', 'font-size': 40}),  # Include style for title
    # TASK 2.2: Add two dropdown menus
        html.Div([
            html.Label("Select Statistics:", style={'color': '#503D36', 'font-size': 32}),
            dcc.Dropdown(id='dropdown-statistics',
                         options=[
                             {'label': 'Yearly Statistics', 'value': 'Yearly Statistics'},
                             {'label': 'Recession Period Statistics', 'value': 'Select Statistics'}
                         ],
                         placeholder='Select a report type',
                         style={'width': '180px', 'height': '50px', 'padding': 16, 'font-size': 20})
        ]),
        html.Div(dcc.Dropdown(id='select-year',
                              options=[{'label': i, 'value': 'Select-year'} for i in year_list],
...
def update_input_container(component_id):
    if component_id =='Yearly Statistics':
        return False
    else:
        return True
